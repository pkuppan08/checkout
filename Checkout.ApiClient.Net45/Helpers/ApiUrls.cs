namespace Checkout
{
    public class ApiUrls
    {
        ...
        public static string GetDrinkFromName
            => _cardApiUri ?? (_cardApiUri = string.Concat(AppSettings.BaseApiUri, "/Drinks?drinkName={0}"));
        public static string Drink
            => _cardsApiUri ?? (_cardsApiUri = string.Concat(AppSettings.BaseApiUri, "/Drinks/{0}"));
